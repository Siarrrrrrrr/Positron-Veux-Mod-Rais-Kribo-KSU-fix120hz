...
// RPMH_REGULATOR_LEVEL_TURBO for veux GPU OC, soo lets test it 
#define RPMH_REGULATOR_LEVEL_TURBO_L1		416
#define RPMH_REGULATOR_LEVEL_TURBO_L2		432
#define RPMH_REGULATOR_LEVEL_SUPER_TURBO	448
#define RPMH_REGULATOR_LEVEL_SUPER_TURBO_NO_CPR	464
